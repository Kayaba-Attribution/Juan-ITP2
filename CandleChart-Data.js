    ...
    this.parseData = function(dataJSON) {
        ...
        // Y - AXIS
            ...
            for (var i = 0; i < 15; i++) {
                ...
                //console.log(i)
                if (parseFloat(dataJSON[this.timeSeries][this.dateKeys[i]]["3b. low (USD)"]) < this.lowest) {
                    this.lowest = parseFloat(dataJSON[this.timeSeries][this.dateKeys[i]]["3b. low (USD)"]);
                    //console.log("LOW: " + i +"  "+ this.lowest)
                }
            ...
            //console.log("Price labels: " +  this.priceLabels)
            //console.log("Price range: " + this.priceRange)
            //console.log("Date labels: " +  this.dateLabels)
            console.log("Finished gathering and organizing data for 15 days")
